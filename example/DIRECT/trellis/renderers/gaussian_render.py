...
def alpha_render(viewpoint_camera, pc : Gaussian, pipe, bg_color : torch.Tensor, scaling_modifier = 1.0, override_color = None, compute_grad_cov2d=True):
    """
    Render the scene. 
...
class GaussianRenderer:
    ...
    def alpha_render(
        ...
        # Render
        render_ret = alpha_render(camera_dict, gausssian, pipe, self.bg_color, override_color=colors_overwrite, scaling_modifier=self.pipe.scale_modifier)
